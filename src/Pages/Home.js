            ...
            <div className="w-[85%] m-auto ">
                <div className="flex flex-col xl:h-[85vh] md:h-[50vh] h-[85vh] justify-center items-center">
                    <div className='space-y-6 text-center'>
                        ...
                        <p className="xl:w-[70%] m-auto tracking-wider">StreetMoney is a peer-to-peer stage designed to enable free direct currency exchange and borderless transfer</p>
